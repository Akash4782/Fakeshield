...
narrative_patterns = [
    r"\b(?:I|my|me|we|us|our)\b", r"\bremember\b", r"\bfelt\b",
    r"\bstruggle\b", r"\bhurdle\b", r"\bsatisfaction\b", r"\bconnection\b"
]

hits = [p for p in narrative_patterns if re.search(p, text, re.I)]
print(f"HITS: {hits}")
