...
const SignupPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center font-sans overflow-y-auto py-8 sm:py-12 p-4" style={{ background: 'var(--page-bg)', color: 'var(--text-primary)' }}>
      ...
      {/* Main Signup Card */}
      <div
        className="relative z-10 w-full max-w-[450px] rounded-[2rem] shadow-[0_50px_100px_rgba(0,0,0,0.15)] p-6 md:p-10 md:transform md:hover:-rotate-1 transition-all duration-700 ease-out"
        style={{
          perspective: '1000px',
          transform: 'none',
      ...
      >
        ...
        <div className="hidden sm:flex absolute -top-6 -left-6 w-12 h-12 bg-[#00E5CC] rounded-full items-center justify-center text-white shadow-lg animate-bounce duration-3000 border-none">
