...
const AboutPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: '#ffffff', color: '#0f172a', fontFamily: "'Inter', sans-serif" }}>
      {/* Navbar */}
      ...
      <main className="flex-grow">
        ...
        <section className="pt-40 pb-24 px-6 border-b border-slate-50">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
              ...
              <div className="flex flex-col gap-6 p-8 rounded-[2.5rem] bg-[#f8fafc] border border-slate-100 shadow-xl shadow-slate-200/50">
                ...
                <div className="space-y-4 font-mono text-[11px] leading-relaxed">
                  <p className="text-slate-400">// FAKESHIELD FORENSIC CORE V14.6.2</p>
                  <p className="text-emerald-600 font-bold">$ fs_engine --scan --multi-modal --target=source_media.mp4</p>
                  <div className="pl-4 space-y-1">
                    <p className="text-slate-500">[INFO] Loading forensic models... DONE (2.4s)</p>
                    <p className="text-slate-500">[INFO] Analyzing FFT spectrum... NOISE_FLOOR_INCONSISTENCY</p>
                    <p className="text-slate-500">[INFO] Extracting optical flow vectors... ANOMALY_DETECTED</p>
                  ...
                  <p className="text-slate-600">[RESULT] Confidence Score: 98.92% (SYNTHETIC)</p>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="flex flex-col md:flex-row gap-20">
              <div className="md:w-1/3 sticky top-32 h-fit">
                ...
                <h3 className="text-3xl font-black text-slate-900 mb-6">How we verify.</h3>
              ...
              <div className="md:w-2/3 space-y-24">
                <div className="group">
                  <div className="text-5xl font-black text-slate-100 mb-6 group-hover:text-[#00E5CC]/20 transition-colors">01</div>
                  <h4 className="text-xl font-bold mb-4">Frequency Domain Analysis</h4>
                ...
                <div className="group">
                  <div className="text-5xl font-black text-slate-100 mb-6 group-hover:text-[#00E5CC]/20 transition-colors">02</div>
                  <h4 className="text-xl font-bold mb-4">Neural Artifact Localization</h4>
                  <p className="text-slate-500 leading-relaxed max-w-lg">
                ...
                <div className="group">
                  <div className="text-5xl font-black text-slate-100 mb-6 group-hover:text-[#00E5CC]/20 transition-colors">03</div>
                  <h4 className="text-xl font-bold mb-4">Multi-Signal Consensus</h4>
                  <p className="text-slate-500 leading-relaxed max-w-lg">
        ...
        <section className="py-16 px-6 relative overflow-hidden" style={{ background: '#00E5CC' }}>
          <div className="max-w-6xl mx-auto relative z-10">
             <div className="mb-12">
               <h2 className="text-3xl font-black text-slate-900 mb-4 tracking-tight">The Forensic Core.</h2>
               <p className="text-slate-800 max-w-xl font-medium text-sm leading-relaxed">
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                {[
                  ...
                  <div key={i} className="p-7 bg-white rounded-3xl shadow-xl shadow-black/5 hover:-translate-y-1 transition-all duration-300 group">
                    ...
                    <p className="text-slate-900 font-bold text-base mb-3">{item.desc}</p>
                    <div className="h-[2px] w-6 bg-slate-100 group-hover:w-10 transition-all duration-500 mb-3"></div>
                    <p className="text-[11px] text-slate-500 font-mono italic leading-tight">{item.tech}</p>
                  </div>
                ))}
             </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="flex flex-col md:flex-row gap-16 items-center">
               <div className="relative group">
                 ...
                 <div className="relative w-48 h-48 rounded-[3rem] bg-slate-50 border border-slate-100 flex items-center justify-center overflow-hidden grayscale hover:grayscale-0 transition-all duration-500">
                    <User size={64} className="text-slate-300" />
                 </div>
               </div>
               <div className="flex-grow">
                 <h2 className="text-4xl font-black mb-6">Akash Virdi</h2>
                 ...
                 <div className="flex gap-3">
                    <a href="https://github.com/Akash4782" target="_blank" rel="noreferrer" className="flex items-center gap-2.5 px-5 py-2.5 rounded-xl bg-white border border-slate-200 text-sm font-bold shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all">
                      <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/github/github-original.svg" className="w-4 h-4" alt="GitHub" />
                      GitHub
                    </a>
                    <a href="https://www.linkedin.com/in/akash-virdi-399ab4253/" target="_blank" rel="noreferrer" className="flex items-center gap-2.5 px-5 py-2.5 rounded-xl bg-white border border-slate-200 text-sm font-bold shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all">
                      <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/linkedin/linkedin-original.svg" className="w-4 h-4" alt="LinkedIn" />
                      LinkedIn
                    </a>
                    <a href="mailto:virdiakash77@gmail.com" className="flex items-center gap-2.5 px-5 py-2.5 rounded-xl bg-white border border-slate-200 text-sm font-bold shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all">
        ...
        <section className="pb-32 px-6">
          <div className="max-w-4xl mx-auto p-12 rounded-[3rem] border border-slate-100 bg-slate-50/50">
