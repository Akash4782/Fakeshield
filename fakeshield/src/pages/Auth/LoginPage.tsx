    ...
    <div className="min-h-screen flex items-start justify-center font-sans overflow-y-auto pt-[0vh] pb-20 p-4" style={{ background: 'var(--page-bg)', color: 'var(--text-primary)' }}>
      ...
      >
        ...
        <form className="space-y-4 md:space-y-6" onSubmit={(e) => e.preventDefault()}>
          ...
          <button
            type="submit"
            className="w-full bg-gradient-to-r from-[#00E5CC] to-[var(--accent-purple)] text-white font-bold py-4 rounded-2xl shadow-xl hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 flex items-center justify-center gap-2 group border-none"
          >
            Log in
          ...
          <div className="grid grid-cols-2 gap-4">
            <button className="flex items-center justify-center gap-3 py-3 px-4 rounded-2xl border transition-all group" style={{ borderColor: 'var(--panel-border)', background: 'var(--btn-secondary-bg)' }}>
