...
# Mock an image with a watermark on a brown background (Saturation ~180-220)
# Let's use a slightly less saturated brown to see if it passes the 110 threshold
# Light Brown: (180, 130, 70)
light_brown = np.array([[[180, 130, 70]]], dtype=np.uint8)
hsv_lb = cv2.cvtColor(light_brown, cv2.COLOR_RGB2HSV)
print(f"Light brown saturation: {hsv_lb[0,0,1]}")
...
print("Running verification on mock light brown ROI...")
