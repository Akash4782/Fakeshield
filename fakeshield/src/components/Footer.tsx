...
const Footer = () => {
  return (
    <footer style={{ background: '#ffffff', borderTop: '1px solid #e5e7eb', padding: '4rem 0 3rem' }}>
      <div style={{ maxWidth: '80rem', margin: '0 auto', padding: '0 1.5rem' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr', gap: '3rem', marginBottom: '4rem' }}>
          ...
          {/* Company */}
          <div>
            <h4 style={{ color: '#374151', fontSize: '0.6875rem', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: '1.25rem' }}>Company</h4>
            <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '0.875rem' }}>
              {[
          ...
          {/* Legal */}
          <div>
            <h4 style={{ color: '#374151', fontSize: '0.6875rem', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: '1.25rem' }}>Legal</h4>
            <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '0.875rem' }}>
              {[
        ...
        {/* bottom bar */}
        <div style={{ borderTop: '1px solid #e5e7eb', paddingTop: '2rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '1rem' }}>
          <p style={{ color: '#9ca3af', fontSize: '0.8125rem' }}>© 2026 FakeShield. All rights reserved.</p>
